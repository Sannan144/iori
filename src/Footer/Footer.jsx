...
const Footer = () => {
  return (
    <div className='w-[calc(100%-8px)] h-screen bg-[#d1d0c7] ml-1 fixed top-0 left-0 z-0 py-20 flex md:justify-between px-10 items-start md:items-center flex-col md:flex-row gap-5 md:gap-0'>

        <div>
          <h1 className='text-[clamp(70px,8vw,100px)] font-[lightFont]'>Get in Touch</h1>
          <button class="cursor-pointer font-semibold overflow-hidden relative z-100 border group px-8 py-2 mb-5">
        ...
        <div className='w-full absolute bottom-0 left-0 font-[Inter] flex justify-between items-start sm:items-center px-10 flex-col sm:flex-row'>
